<template>
    <div class="p-4 mb-3 bg-light rounded text-center">
        <div class="mb-3 row row-cols-1">
            ...
            <div class="col">
                <h4 class="fst-italic">{{ name }} &nbsp;
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16" v-if="blogRoute == updateStatus">
